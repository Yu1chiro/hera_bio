...
const Navbar = () => {
  ...
  return (
    <div className={!showShadowNav ? 'fixed w-full h-[80px] flex justify-between items-center px-4 bg-gradient-to-l from-[#020617] to-[#0a37a1] text-gray-300 z-20':'fixed w-full h-[80px] flex justify-between items-center px-4 bg-gradient-to-l from-[#020617] to-[#0a37a1] text-gray-300 z-20 shadow-2xl'}>
  <div className="flex items-center">
    ...
    <h2 className="text-white text-base ml-2 font-bold">Yuichiro</h2>
      ...
      <div className={
        !nav
          ? "hidden"
          : "absolute top-0 left-0 w-full h-screen bg-gradient-to-l from-[#020617] to-[#0a37a1]  flex flex-col justify-center items-center transition ease-in-out duration-300 delay-700"
      }>
        {/* Added comments for mobile menu */}
        <div>
          <img src={Logo} alt="logo" style={{ width: "80px" }} className="mb-7" />
        </div>
        <ul
      ...
      <div className="hidden lg:flex fixed flex-col top-[35%] left-0">
        <ul>
          <li className="w-[160px] h-[60px] mb-2 flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-slate-200 rounded-e-2xl font-semibold">
            <a
              href="https://www.google.com/nonexistentpage"
          ...
          <li className="w-[160px] h-[60px] mb-2 flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-slate-200 rounded-e-2xl font-semibold">
            <a
              href="mailto:ryuukiharukaze25@gmail.com" 
              className="flex justify-between items-center w-full text-[#0a37a1]"
            >
